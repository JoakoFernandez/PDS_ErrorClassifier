...
export const STATIC_ERROR_MAP: Record<string, StaticEntry> = {
  ...
  '504': {
    ...
    userMessage:
      "Our payment system is taking too long to respond right now. Your card has not been charged. Please try again in a moment.",
  ...
  '500': {
    ...
    userMessage:
      "We experienced an internal error while processing your payment. No charge was made. Our team has been alerted.",
    suggestedActions: [retry, contactSupport],
    severity: 'high',
    category: 'server',
    shouldEscalateToSupport: false,
  ...
  '503': {
    ...
    userMessage:
      "Our payment service is temporarily down for maintenance. Please try again in a few minutes.",
  ...
  '429': {
    ...
    userMessage:
      "You've made too many payment attempts in a short period. Please wait a minute before trying again.",
  ...
  '401': {
    ...
    userMessage:
      "Your session has expired. Please log in again and reattempt your payment.",
  ...
  'INVALID_PARAM': {
    ...
    userMessage:
      "Some of your payment details appear to be missing or in the wrong format. Please review and resubmit.",
  ...
  'INVALID_CARD_NUMBER': {
    ...
    userMessage:
      "The card number you entered doesn't look right. Please double-check all 16 digits.",
  ...
  'INVALID_CVV': {
    ...
    userMessage:
      "The 3 or 4-digit security code on your card doesn't match. Please re-enter it carefully.",
    suggestedActions: [updateCard],
    severity: 'low',
    category: 'validation',
    shouldEscalateToSupport: false,
  ...
  'MISSING_BILLING_ADDRESS': {
    ...
    userMessage:
      "Your billing address is missing. Please add your address to complete this payment.",
  ...
  'CARD_DECLINED': {
    ...
    userMessage:
      "Your card was declined by your bank. This can happen for several reasons — please contact your bank or try a different card.",
  ...
  'INSUFFICIENT_FUNDS': {
    ...
    userMessage:
      "Your card doesn't have enough available balance for this transaction. Please use a different payment method.",
  ...
  'CARD_EXPIRED': {
    ...
    userMessage:
      "The card on file has passed its expiry date. Please add a new card to continue.",
  ...
  'CARD_NOT_SUPPORTED': {
    ...
    userMessage:
      "We don't currently accept this type of card. Please try Visa, Mastercard, or American Express.",
    suggestedActions: [useDifferentCard],
    severity: 'low',
    category: 'payment_method',
    shouldEscalateToSupport: false,
  ...
  'DO_NOT_HONOR': {
    ...
    userMessage:
      "Your bank has declined this transaction. Please contact them directly to authorise the payment, then try again.",
    suggestedActions: [contactBank, useDifferentCard],
    severity: 'medium',
    category: 'payment_method',
    shouldEscalateToSupport: false,
  ...
  'LOST_CARD': {
    ...
    userMessage:
      "The card associated with your account has been reported lost or stolen. Please add a new card.",
  ...
  'STOLEN_CARD': {
    ...
    userMessage:
      "This card has been flagged as stolen. For your security, please contact your bank immediately.",
  ...
  'RESTRICTED_CARD': {
    ...
    userMessage:
      "Your bank has restricted this card for online or international transactions. Please contact your bank or use a different card.",
    suggestedActions: [contactBank, useDifferentCard],
    severity: 'medium',
    category: 'payment_method',
    shouldEscalateToSupport: false,
  ...
  'FRAUD_SUSPECTED': {
    ...
    userMessage:
      "This payment has been flagged for additional review. No charge has been made. Please contact our support team to complete your purchase.",
  ...
  'NETWORK_ERROR': {
    ...
    userMessage:
      "We lost the connection while processing your payment. Your card has not been charged. Please check your internet connection and try again.",
    suggestedActions: [retry],
    severity: 'medium',
    category: 'network',
    shouldEscalateToSupport: false,
  ...
  'CONNECTION_TIMEOUT': {
    ...
    userMessage:
      "The payment connection timed out. No charge was made. Please try again.",
    suggestedActions: [retry],
    severity: 'medium',
    category: 'timeout',
    shouldEscalateToSupport: false,
