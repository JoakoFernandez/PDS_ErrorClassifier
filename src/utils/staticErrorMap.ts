...
import type { ClassifiedError, ErrorCategory, Severity, SuggestedAction } from '../types';

/** Partial classification stored in the map; runtime fields are added at query time. */
type StaticEntry = Omit<
  ClassifiedError,
  'originalCode' | 'supportReferenceCode' | 'classifiedAt' | 'source' | 'confidence'
>;

const retry: SuggestedAction = {
  label: 'Intentar de nuevo',
  description: 'Espera unos segundos e intenta realizar el pago otra vez.',
};

const updateCard: SuggestedAction = {
...
const contactBank: SuggestedAction = {
...
const contactSupport: SuggestedAction = {
...
const useDifferentCard: SuggestedAction = {
...
export const STATIC_ERROR_MAP: Record<string, StaticEntry> = {
  ...
  '504': {
    ...
    userMessage:
      'Nuestro sistema de pagos está tardando en responder. No se ha realizado ningún cargo a tu tarjeta. Por favor, intenta de nuevo en unos momentos.',
  ...
  '500': {
    ...
    userMessage:
      'Ocurrió un error interno al procesar tu pago. No se realizó ningún cargo. Nuestro equipo ya fue notificado.',
    suggestedActions: [retry, contactSupport],
    severity: 'high',
    category: 'server',
    shouldEscalateToSupport: false,
  ...
  '503': {
    ...
    userMessage:
      'Nuestro servicio de pagos está en mantenimiento por unos momentos. Por favor, intenta de nuevo en unos minutos.',
  ...
  '429': {
    ...
    userMessage:
      'Has realizado demasiados intentos de pago en poco tiempo. Espera un minuto antes de intentar de nuevo.',
  ...
  '401': {
    ...
    userMessage:
      'Tu sesión ha expirado. Por favor, inicia sesión nuevamente e intenta realizar el pago.',
  ...
  'INVALID_PARAM': {
    ...
    userMessage:
      'Falta información o algunos datos tienen un formato incorrecto. Revísalos e inténtalo de nuevo.',
  ...
  'INVALID_CARD_NUMBER': {
    ...
    userMessage:
      'El número de tarjeta ingresado no parece correcto. Verifica los 16 dígitos.',
  ...
  'INVALID_CVV': {
    ...
    userMessage:
      'El código de seguridad de 3 o 4 dígitos no coincide. Ingrésalo nuevamente con cuidado.',
    suggestedActions: [updateCard],
    severity: 'low',
    category: 'validation',
    shouldEscalateToSupport: false,
  ...
  'MISSING_BILLING_ADDRESS': {
    ...
    userMessage:
      'Falta tu dirección de facturación. Agrega la dirección registrada en tu tarjeta para completar el pago.',
  ...
  'CARD_DECLINED': {
    ...
    userMessage:
      'Tu banco rechazó la transacción. Esto puede ocurrir por varias razones. Contacta a tu banco o prueba con otra tarjeta.',
  ...
  'INSUFFICIENT_FUNDS': {
    ...
    userMessage:
      'Tu tarjeta no tiene saldo disponible suficiente para esta transacción. Usa otro método de pago.',
  ...
  'CARD_EXPIRED': {
    ...
    userMessage:
      'La tarjeta registrada ya pasó su fecha de vencimiento. Agrega una tarjeta nueva para continuar.',
  ...
  'CARD_NOT_SUPPORTED': {
    ...
    userMessage:
      'Actualmente no aceptamos este tipo de tarjeta. Prueba con Visa, Mastercard o American Express.',
    suggestedActions: [useDifferentCard],
    severity: 'low',
    category: 'payment_method',
    shouldEscalateToSupport: false,
  ...
  'DO_NOT_HONOR': {
    ...
    userMessage:
      'Tu banco rechazó esta transacción. Contáctalos para autorizar el pago y vuelve a intentarlo.',
    suggestedActions: [contactBank, useDifferentCard],
    severity: 'medium',
    category: 'payment_method',
    shouldEscalateToSupport: false,
  ...
  'LOST_CARD': {
    ...
    userMessage:
      'La tarjeta asociada a tu cuenta fue reportada como perdida o robada. Por favor, agrega una tarjeta nueva.',
  ...
  'STOLEN_CARD': {
    ...
    userMessage:
      'Esta tarjeta fue marcada como robada. Por tu seguridad, contacta a tu banco inmediatamente.',
  ...
  'RESTRICTED_CARD': {
    ...
    userMessage:
      'Tu banco restringió esta tarjeta para transacciones en línea o internacionales. Contacta a tu banco o usa otra tarjeta.',
    suggestedActions: [contactBank, useDifferentCard],
    severity: 'medium',
    category: 'payment_method',
    shouldEscalateToSupport: false,
  ...
  'FRAUD_SUSPECTED': {
    ...
    userMessage:
      'Este pago fue marcado para revisión adicional. No se realizó ningún cargo. Contacta a nuestro equipo de soporte para completar tu compra.',
  ...
  'NETWORK_ERROR': {
    ...
    userMessage:
      'Perdimos la conexión mientras procesábamos tu pago. No se realizó ningún cargo. Verifica tu conexión a internet e inténtalo de nuevo.',
    suggestedActions: [retry],
    severity: 'medium',
    category: 'network',
    shouldEscalateToSupport: false,
  ...
  'CONNECTION_TIMEOUT': {
    ...
    userMessage:
      'La conexión de pago se agotó. No se realizó ningún cargo. Por favor, inténtalo de nuevo.',
    suggestedActions: [retry],
    severity: 'medium',
    category: 'timeout',
    shouldEscalateToSupport: false,
 ...
 */
export function lookupStaticError(code: string): StaticEntry | undefined {
  return STATIC_ERROR_MAP[code.trim().toUpperCase()];
}
